    ...
    <form class="box" id="form1" runat="server">
        ...
        <table class="auto-style1"   align="center">
            ...
            <tr>
                ...
                <td class="auto-style10" style="text-align:left;">
                    <asp:Image  ID="Image1" runat="server" Width="176px" Height="200px" />
                </td>
            </tr>
        ...
        <p style="text-align:center;">
            <asp:Button ID="back" runat="server" OnClick="back_click" Text="Back" style="height: 35px;" CssClass="btn btn-danger" />&nbsp;&nbsp;
            <asp:Button ID="updateprofile" runat="server" Text="Update Profile" OnClick="updateProfile_click" style="height: 35px;" CssClass="btn btn-danger" />
        </p>
        </div>
    </form>
</body>
